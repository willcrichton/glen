/*********************************
* Beatnik.js
* @author: Created by Will Crichton, 2012
...
Beatnik = function( mp3, fftCallback, audioLoadCallback ){
	...
	if( RegExp(" AppleWebKit/").test(navigator.userAgent) ){
		...
		var context = RegExp(" AppleWebKit/").test(navigator.userAgent) ? new webkitAudioContext() : new AudioContext();
		...
		this.validAPI = false;
		console.log("Need Firefox API here.");
